...
from appointments_app.appointments_app.doctype.appointment_queue.appointment_queue import (
...
class TestAppointmentQueue(FrappeTestCase):
    def test_create_queues_for_today(self):
        ...
        test_shift1 = frappe.get_doc(
            {
                "doctype": "Schedule Shift",
                "start_time": "9:00:00",
                "end_time": "15:00:00",
                "clinic": clinic.name,
            }
